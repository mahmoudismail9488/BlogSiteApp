...
app.get("/",function(res,res){
  res.render("home",{home_text:homeStartingContent,my_post_data:posts})
})
...
if(_.lowerCase(ele.title) === _.lowerCase(req.params.topic)){
  state = true;
  res.render("post",{post_title:ele.title,post_content:ele.data})
}
  })
  if(state === false){
    res.redirect("/")
...
app.post("/compose",function(req,res){
  const my_post = {title:req.body.postTitle,
